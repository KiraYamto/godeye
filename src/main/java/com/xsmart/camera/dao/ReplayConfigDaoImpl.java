...
public class ReplayConfigDaoImpl implements ReplayConfigDao {
    ...
    public void insertReplayConfig(GstCameraReplayConfigDto replayConfigDto) throws Exception {
        ...
        this.jdbcTemplate.update(sql,new Object[]{replayConfigDto.getConfigId(),replayConfigDto.getCameraId(),replayConfigDto.getReplayOn(),replayConfigDto.getProvider(),replayConfigDto.getRtspAddr()
  ...
  //  @CachePut(value = "ReplayConfig" ,key = "#p0.cameraId")
    ...
    public void updateReplayConfig(GstCameraReplayConfigDto replayConfigDto) throws Exception {
        String sql = "UPDATE gst_camera_replay_config A\n" +
                ...
                " where a.CAMERA_ID = ? ";
        this.jdbcTemplate.update(sql,new Object[]{replayConfigDto.getReplayOn(),replayConfigDto.getProvider(),replayConfigDto.getRtspAddr(),replayConfigDto.getTsFilePath(),replayConfigDto.getMonitorFilePath(),replayConfigDto.getVcodec(),replayConfigDto.getPlayer(),replayConfigDto.getCameraId()});
